...
type taxRatesByYear = IntMap.t(taxRates);

let singleTaxRatesByYear: taxRatesByYear = IntMap.empty;

// Year 2014 Single Tax Rates
let singleTaxRatesByYear = IntMap.add(
  2014,
  {
    federal: {
      fica: {
...
let get_first_item_in_pair_tuple = pair => {
  let (a, _) = pair;
  a;
}
